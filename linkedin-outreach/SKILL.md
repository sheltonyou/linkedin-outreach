...
# LinkedIn Outreach — Job Seeker Messages
...
**Scenario A:**
- Person's name and title/company
- Role title and company being applied to
- Already applied, or about to apply?

**Scenario B:**
- Person's name and title/company
- Why do they seem relevant? (sector, specialisation, recommended?)

**Follow-up:**
- Which scenario was the original connection?
- How long ago did they accept?
- Did they reply to your original message, or just silently accept?

---

## Scenario A — Role-triggered connection request

**What to include:**
- Mention you applied (or are applying)
- Point to the specific role or project context briefly
- A natural connect ask

**What NOT to include:**
- "matched my background well" — sounds like a self-assessment, not a greeting
- "looks like a strong fit" — cover letter language
- "exactly the kind of work I'm targeting" — unnecessary justification
- Any ask for status updates, chats, or their time
...
## Scenario B — Exploratory connection request

**What to include:**
- Who you are (one line: role + location)
- Why you're connecting *to them specifically* (their focus area, their sector, their type of work)
- A light connect ask

**What NOT to include:**
- "would love to be on your radar" — too eager, sounds like you want something immediately
- "exactly my focus area" — slightly mechanical
- "connect and chat" — don't propose a chat before they've accepted
- "see where it might lead" — vague and meaningless
- "I came across your profile and was impressed" with no specific reason — generic
...
### They accepted but didn't reply (2–5 days)
...
**What NOT to do yet:**
- Don't ask if they're actively placing
- Don't offer to send your CV
- Don't propose a call or "10 minutes"
- Don't ask them to "keep you in mind"
...
### They accepted, you followed up, still no reply (5–10 days)
...
**Length:**
- Connection request: 1–3 sentences. 300-character limit. Lean toward the shorter end.
- Follow-up message: 2–4 sentences. Fits in a single screen view.
...
- Self-match statements ("strong fit", "my background aligns perfectly")
- Mass-send phrasing ("please keep me in mind for any suitable roles")
- Premature asks (chat/call/CV before they've engaged)
- Vague warmth ("so great to come across your profile")
